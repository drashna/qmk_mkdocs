...
1. Vous avez un compte GitHub, et avez [créé un "fork" pour le dépôt qmk_firmware](getting_started_github.md) avec votre compte.
2. Vous avez [configuré votre environnement de compilation](tutorial_getting_started.md?id=environment-setup).
