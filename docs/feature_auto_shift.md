...
!!! tip
    Auto Shift has three special keys that can help you get this value right very quick. See [Using Auto Shift Setup](#using-auto-shift-setup) for more details!
