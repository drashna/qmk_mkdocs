...
!!! question "Is This Guide For Me?"
    If the thought of programming intimidates you, please [take a look at our online GUI](tutorial_building_firmware_configurator.md) instead.
...
1. [Setup Your Environment](tutorial_getting_started.md)
2. [Building Your First Firmware](tutorial_building_firmware.md)
3. [Flashing Firmware](tutorial_flashing.md)
...
Beyond this guide there are several resources you may find helpful while you learn QMK. We've collected them on the [Syllabus](syllabus.md) and [Learning Resources](tutorial_learn_more_resources.md) pages.
