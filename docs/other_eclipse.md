...
# Prerequisites
## Build Environment
Before starting, you must have followed the [Getting Started](tutorial_getting_started.md) section of the Tutorial. In particular, you must have been able to build the firmware with [the `qmk compile` command](tutorial_building_firmware.md#build-your-firmware).
